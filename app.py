                    ...
                    try:
                        ...
                        if similar_jobs:
                            ...
                            return ChatResponse(
                                ...
                                jobs=job_results,
                                suggestions=["Show more jobs", "Jobs in specific location", "Add more skills", "Filter by experience"]
                            )
                        else:
                            return ChatResponse(
                                ...
                                chat_phase="profile_building",
                                profile_data={"skills": skills},
                                suggestions=[f"{skills[0]} jobs in Mumbai", "Jobs in Bangalore", "Remote work", "Add more skills"]
                            )
                    except Exception as e:
